...
final class RulePropertySetter
{
    ...
    /** @var ?array<string, array{string, ReflectionProperty, RuleProperty}> */
     ...
     * @throws InvalidRulePropertyTypeException
     */
    public static function setValue(Rule $rule, string $name, bool|float|int|string $value): void
    {
    ...
    /**
     * @param ReflectionClass<Rule> $class
