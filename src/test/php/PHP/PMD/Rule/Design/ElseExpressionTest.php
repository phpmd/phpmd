...
require_once 'PHP/PMD/Rule/Design/ElseExpression.php';

class PHP_PMD_Rule_Design_ElseExpressionTest extends PHP_PMD_AbstractTest
{
    public function testRuleNotAppliesToMethodWithoutElseExpression()
    {
        $rule = new PHP_PMD_Rule_Design_ElseExpression();
